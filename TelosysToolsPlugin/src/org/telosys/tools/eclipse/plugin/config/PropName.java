...
public class PropName {
    ...
    //--- Directories 
    //public final static String GENERATOR_DIRECTORY    = "generatorDirectory";

    //public final static String PROJECT_ROOT_DIRECTORY = "projectRootDirectory";
...
//
//    public final static String PACKAGE_DAO            = GeneratorConfigConst.PACKAGE_DAO ; //"packageDao";
//
//    public final static String PACKAGE_XML_MAPPER     = GeneratorConfigConst.PACKAGE_XML_MAPPER ; //"packageXmlMapper";
//
//    
//    public final static String PACKAGE_SCREEN_DATA       = GeneratorConfigConst.PACKAGE_SCREEN_DATA ; //"packageScreenData";
//    
//    public final static String PACKAGE_SCREEN_MANAGER    = GeneratorConfigConst.PACKAGE_SCREEN_MANAGER ; // "packageScreenManager";
//
//    public final static String PACKAGE_SCREEN_PROCEDURES = GeneratorConfigConst.PACKAGE_SCREEN_PROCEDURES ; // "packageScreenProcedures";
//    
//    public final static String PACKAGE_SCREEN_TRIGGERS   = GeneratorConfigConst.PACKAGE_SCREEN_TRIGGERS ; // "packageScreenTriggers";

    //public final static String PACKAGE_TEST              = "packageTest";

//    //--- Classes names 
//    public final static String CLASS_NAME_VO_LIST    = "VOListClassName" ;
//    
//    public final static String CLASS_NAME_DAO        = "DAOClassName" ;
//    
