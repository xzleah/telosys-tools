 ...
 *  
 */
public class VOBeanField implements ISelectedClassField {
...
//			PluginLogger.log("FieldEvents : modifyText() ");
...
//	}
	...
	// The class itself
	//======================================================================
	public VOBeanField(int iId, IWizardPageEvents wizardPageEvt,
			Shell shell, IJavaProject javaProject, String sMask) {
//		_iFieldId = iId ;
//		_wizardPageEvt = wizardPageEvt;
//		_field = new LabelButtonField(iId, "V.O. bean :", "Browse ...",
//				new FieldEvents(), new ButtonEvents());
		_field = new LabelButtonField(iId, "V.O. bean :", "Browse ...", wizardPageEvt, new ButtonEvents());
		_shell = shell;
